...
<body>
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="assets/images/logo/logo_1x.png" srcset="assets/images/logo/logo_2x.png 2x"
                                        alt>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="assets/images/logo/logo_1x.png"
    ...
    <script src="{{ asset('assets/js/jquery-plugins-collection.js') }}"></script>
