                                ...
                                <div class="dropdown mb-3 show">
                                    <button type="button" class="btn rounded btn-light" data-toggle="dropdown"
                                        ...
                                        <svg class="ml-2" width="14" height="8" viewBox="0 0 14 8" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 0.999999L7 7L13 1" stroke="#0B2A97" stroke-width="2"
                                                ...
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center">
                                                            ...
                                                            <a href="app-profile.html" class="btn-link fs-14">Send
                                                                Request</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center">
                                                            ...
                                                            <span
                                                                class="fs-14 d-block ml-2 pr-2 mr-2 border-right text-black font-w500">4.4</span>
                                                            <a href="javascript:void(0)" class="btn-link fs-14">Send
                                                                Request</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header d-sm-flex d-block pb-0 border-0">
                                        ...
                                        <div class="dropdown mt-sm-0 mt-3">
                                            <button type="button" class="btn rounded btn-primary dropdown-toggle"
                                ...
                                <div class="card featuredMenu">
                                    ...
                                    <div class="card-body loadmore-content height750 dz-scroll pt-0"
                                        ...
                                        <div class="media mb-4">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="food-menu.html" class="text-black fs-16">Chinese Orange
                                                        Fruit With Avocado Salad</a></h5>
                                        ...
                                        <div class="media mb-4">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="food-menu.html" class="text-black fs-16">Fresh or Frozen
                                                        (No Sugar Added) Fruits</a></h5>
                                        ...
                                        <div class="media mb-4">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="food-menu.html" class="text-black fs-16">Original Boiled
                                                        Egg with Himalaya Salt</a></h5>
